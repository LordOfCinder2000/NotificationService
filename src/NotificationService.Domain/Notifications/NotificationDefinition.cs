...
/// </summary>
public class NotificationDefinition : IHasSimpleStateCheckers<NotificationDefinition>
{
    /// <summary>
    ...
    public List<ISimpleStateChecker<NotificationDefinition>> StateCheckers { get; }
    ...
    public NotificationDefinition(string name, Type entityType = null, ILocalizableString displayName = null, ILocalizableString description = null)
    {
        ...
        StateCheckers = new List<ISimpleStateChecker<NotificationDefinition>>();
    }
}
