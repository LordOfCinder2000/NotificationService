...
public interface IUserNotificationManager
{
    ...
    Task<List<UserNotificationInfo>> GetUserNotificationsAsync(UserIdentifier user, UserNotificationState? state = null, int skipCount = 0, int maxResultCount = int.MaxValue, DateTime? startDate = null, DateTime? endDate = null);
