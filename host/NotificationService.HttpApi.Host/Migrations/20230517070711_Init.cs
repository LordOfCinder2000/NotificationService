...
namespace NotificationService.Migrations
{
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "NotificationServiceTenantNotifications",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ...
                    DataTypeName = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    EntityTypeName = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    EntityTypeAssemblyQualifiedName = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                    EntityId = table.Column<string>(type: "nvarchar(96)", maxLength: 96, nullable: true),
                    Severity = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotificationServiceTenantNotifications", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "NotificationServiceNotificationSubscriptions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotificationServiceNotificationSubscriptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NotificationServiceNotificationSubscriptions_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "NotificationServiceUserNotifications",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotificationServiceUserNotifications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NotificationServiceUserNotifications_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NotificationServiceUserNotifications_NotificationServiceTenantNotifications_TenantNotificationId",
                        column: x => x.TenantNotificationId,
                        principalTable: "NotificationServiceTenantNotifications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationServiceNotifications_NotificationName",
                table: "NotificationServiceNotifications",
                column: "NotificationName");

            migrationBuilder.CreateIndex(
                name: "IX_NotificationServiceNotificationSubscriptions_NotificationName",
                table: "NotificationServiceNotificationSubscriptions",
                column: "NotificationName");

            migrationBuilder.CreateIndex(
                name: "IX_NotificationServiceNotificationSubscriptions_UserId",
                table: "NotificationServiceNotificationSubscriptions",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_NotificationServiceTenantNotifications_NotificationName",
                table: "NotificationServiceTenantNotifications",
                column: "NotificationName");

            migrationBuilder.CreateIndex(
                name: "IX_NotificationServiceUserNotifications_TenantNotificationId",
                table: "NotificationServiceUserNotifications",
                column: "TenantNotificationId");

            migrationBuilder.CreateIndex(
                name: "IX_NotificationServiceUserNotifications_UserId",
                table: "NotificationServiceUserNotifications",
                column: "UserId");
        }
